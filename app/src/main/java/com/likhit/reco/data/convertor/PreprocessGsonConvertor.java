package com.likhit.reco.data.convertor;
...
public class PreprocessGsonConvertor extends Converter.Factory {
    ...
    public static PreprocessGsonConvertor create() {
        return create(new Gson());
    }

    public static PreprocessGsonConvertor create(Gson gson) {
        return new PreprocessGsonConvertor(gson);
    }

    private PreprocessGsonConvertor(Gson gson) {
        if (gson == null) {
